  ...
  return (
    <>
      <div className="mb-[26px]">
        <h2>Paramètres</h2>
        <p className="mt-1.5 text-plume">Tes informations et les règles du site.</p>
      </div>
      ...
      <div className="grid items-start gap-5 lg:grid-cols-[1fr_360px]">
        <div className="flex flex-col gap-5">
          ...
          <section className="rounded-md border border-sable bg-white p-[22px]">
            ...
            <p className="mb-5 max-w-[62ch] text-[13px] text-plume">
          ...
          <section className="rounded-md border border-sable bg-white p-[22px]">
            ...
            <dl className="flex flex-col gap-3 text-[15px]">
              <div className="flex items-center justify-between gap-3">
                <dt className="text-plume">Paiements</dt>
                <dd>
                  {stripeEnModeTest() ? (
              ...
              <div className="flex items-center justify-between gap-3">
                <dt className="text-plume">Formules en vente</dt>
                <dd className="font-medium">
                  {(formules ?? []).filter((f) => f.stripe_price_id).length} sur {formules?.length ?? 0}
                </dd>
              </div>
              <div className="flex items-center justify-between gap-3">
                <dt className="text-plume">Lieux ouverts</dt>
